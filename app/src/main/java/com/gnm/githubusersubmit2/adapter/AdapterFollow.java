...
public class AdapterFollow extends RecyclerView.Adapter<AdapterFollow.ItemDetailHolder> {

    private List<ModelFollower> detailList = new ArrayList<>();
    ...
    public void setDetail(List<ModelFollower> detail) {
        this.detailList = detail;
    }

    public List<ModelFollower> getList() {
        return detailList;
    }
    ...
    public void setOnItemClickListner(AdapterFollow.onItemClickListner onItemClickListner) {
    ...
    class ItemDetailHolder extends RecyclerView.ViewHolder {
        ...
        public void bindView(final ModelFollower detail) {
